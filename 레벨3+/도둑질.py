def solution(money) : 
	# 연결리스트
	# 연속해서 털지못하니까 처음과 끝 중에 하나만 털어야 함. 

	dp1, dp2 = [0 for i in range(len(money))], [0 for i in range(len(money))]
...
def main() : 
	money = [1, 2, 3, 1]	# 4
	money = [1,3,2,2,4,4,1,2,4,9,3,11,2,5] # 1+2+4+2+9+11 = 29 / 5+3+4+2+9+11 = 34
